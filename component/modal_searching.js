         ...
         <div class="modal-content">
            <div class="modal-header border-0 pb-0">
               <div class="input-group input-group-lg border border-2 border-dark rounded overflow-hidden">
                  ...
                  -->
                  <input type="search" class="form-control border-0 px-0 bg-transparent" placeholder="Pencarian" style="font-size: 1rem!important;">
               </div>
               <!--
            ...
            <div class="modal-body">
               ...
               <section class="mb-4">
                  ...
                  -->
                  <h6 class="small"><strong>Item Pencarian</strong></h6>
