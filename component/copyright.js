	...
	<footer id="copyright" class="bg-light border-top small" style="color: #878787;">
	    <div class="container py-5">
	        <div class="row gy-5 gy-md-0 gx-md-5">
	            <div class="col col-12 col-md-5 order-md-2 ms-md-auto col-lg-4 col-xxl-3">
	                <p class="lh-1 mb-md-5">
	                    <img src="assets/img/logotype.svg" width="100%" height="auto" style="max-width: 272px;">
	                    <br>
	                    <small class="opacity-75">Indraco Roasting fine exquisite coffee since 1971.</small>
	                </p>
	    ...
	    <div class="bg-dark" style="color: #b4b4b4;">
	        <div class="container py-3">
	            <div class="row g-3 align-items-lg-start">
	                <div class="col col-12 fs-4 d-flex align-items-center column-gap-3 col-lg-auto order-lg-2">
	                    ...
	                    <a class="text-decoration-none text-reset ms-auto ms-lg-4" href="#" target="_blank">
	                        <img src="assets/img/play.webp" width="auto" height="32">
	                    </a>
	                </div>
	                <div class="col col-12 col-lg order-lg-1">
	                    <nav style="--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
	                        <ol class="breadcrumb mb-2 text-capitalize">
	                            ...
	                            <li class="breadcrumb-item">
	                                <a>
	                                    <select style="font-size: inherit; color: inherit; border-radius: 0; background-color: #565656; border-width: 0;">
	                    ...
	                    <small>&copy; 2023 INDRACO. Hak cipta dilindungi undang-undang.</small>
	                </div>
	            </div>
	        </div>
	    </div>
